...
[![GitHub stars](https://img.shields.io/github/stars/ma-qiankun/smart-qa?style=social)](https://github.com/ma-qiankun/smart-qa)
...
└── smartqa/                 # Spring Boot 后端工程
    ...
    ├── src/main/resources/
    │   └── application.yml
    ├── uploads/             # 上传文件目录（运行时生成，已 gitignore）
    ├── pom.xml
    └── mvnw / mvnw.cmd
```
...
- 仓库地址：https://github.com/ma-qiankun/smart-qa
- Spring Boot 文档：https://docs.spring.io/spring-boot/3.5.14/reference/
